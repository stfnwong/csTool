...
% varargin   command line arguments to csToolTrackOpts (see VARARGIN)
	...
	set(handles.pmAnchorPoint, 'String', spAnch);
...
function bAccept_Callback(hObject, eventdata, handles)  %#ok <INUSL,DEFNU>
    ...
    anchIdx     = get(handles.pmAnchorPoint, 'Value');
	sparseAnch  = get(handles.pmAnchorPoint, 'String');
    sparseAnch  = sparseAnch{anchIdx};
